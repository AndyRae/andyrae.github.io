	...
	L.AwesomeMarkers.Icon = L.Icon.extend({
		...
		_createInner: function () {
			var e,
				...
				r = '',
				i = this.options;
			i.icon.slice(0, i.prefix.length + 1) === i.prefix + '-'
				? (e = i.icon)
				: (e = i.prefix + '-' + i.icon);
			i.spin && typeof i.spinClass == 'string' && (t = i.spinClass);
			i.iconColor &&
				(i.iconColor === 'white' || i.iconColor === 'black'
					? (n = 'icon-' + i.iconColor)
					: (r = "style='color: " + i.iconColor + "' "));
			return (
				'<i ' +
				r +
				"class='" +
		...
		_setIconStyles: function (e, t) {
			var n = this.options,
				r = L.point(n[t === 'shadow' ? 'shadowSize' : 'iconSize']),
				i;
			t === 'shadow'
