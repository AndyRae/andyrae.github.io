...
function fetchbar() {
	...
	var query = new google.visualization.Query(
			'https://docs.google.com/spreadsheets/d/1yva24ltQe6S4chDKZXM3TI-iW-zroSuYHL48_BZMAfI/gviz/tq?gid=1518990147&headers=0&range=A2:C99&tq=' + queryString);
			query.send(drawbar);
};
//draw-bar-chart
...
function fetchcandle() {
	...
	var query = new google.visualization.Query(
			'https://docs.google.com/spreadsheets/d/1yva24ltQe6S4chDKZXM3TI-iW-zroSuYHL48_BZMAfI/gviz/tq?gid=1518990147&headers=0&range=A2:E99&tq=' + queryString);
